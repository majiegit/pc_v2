export default {
  ...
  'user.login.username.placeholder': '请输入登录账号',
  'user.login.password.placeholder': '请输入登录密码',
  'user.login.verificationCode.placeholder': '请输入验证码',
  ...
  'user.login.mobile.verification-code.placeholder': '短信验证码',
  ...
  'user.register.username.placeholder': '请输入账号',
  'user.register.email.placeholder': '邮箱',
  'user.register.password.placeholder': '请输入密码',
  ...
  'user.register.sign-in': '使用已有账号登录',
  'user.register-result.msg': '你的账号：{email} 注册成功',
